...
namespace TPI
{
    public partial class AltaCiudad : Form
    {
        ...
        private void AltaCiudad_Load(object sender, EventArgs e)
        {
            LimpiarCampos();
            CargarComboPais();
            CargarComboProvincia((int)cmbPais.SelectedValue);
        ...
        private Ciudad ObtenerDatosCiudad()
        {
            ...
            else
            {
                ...
                if (cmbProvincia.SelectedIndex == -1)
                {
                    ...
                    MessageBox.Show("Seleccione la provincia");
                    cmbProvincia.Focus();
            ...
            if (hayIdProvincia && hayNombre)
            {
                if (txtIdCiudad.Text.Equals(""))
                {
                    ...
                    c.IdProvinciaCiudad = (int)cmbProvincia.SelectedValue;
                }
                else
                {
        ...
        private void gdrCiudades_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            try
            {
                ...
                LimpiarCampos();
                CargarCampos2(c.IdProvinciaCiudad);
                CargarCampos(c);
            }
            catch (Exception ex)
            {
        ...
        private void CargarCampos(Ciudad c)
        {
            ...
            cmbProvincia.SelectedValue = c.IdProvinciaCiudad;
        }
        private void CargarCampos2(int IdProvincia)
        {
            cmbPais.SelectedValue = AD_Ciudades.ObtenerListadoPais(IdProvincia);
        }
        ...
        {
            if ((int)cmbPais.SelectedIndex > 0)
            {
                CargarComboProvincia((int)cmbPais.SelectedValue);
            }
            else
